...
[("3D View",
  ...
  {"items":
   [("view3d.cursor3d", {"type": 'RIGHTMOUSE', "value": 'PRESS', "shift": True}, None),
    ...
    ("view3d.navigate", {"type": 'RIGHTMOUSE', "value": 'PRESS'}, None),
    ...
    ("wm.context_scale_float",
     {"type": 'NUMPAD_PLUS', "value": 'PRESS', "repeat": True},
     {"properties":
      [("data_path", 'space_data.overlay.grid_scale'),
       ("value", 2.0),
       ],
      },
     ),
 ...
 ("3D View Generic",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("class.editcall", {"type": 'F', "value": 'PRESS', "shift": True}, None),
    ("class.slicecall", {"type": 'F', "value": 'PRESS', "ctrl": True}, None),
    ("class.cutcall", {"type": 'F', "value": 'PRESS', "alt": True}, None),
    ("wm.call_menu_pie",
     {"type": 'F', "value": 'PRESS'},
     {"properties":
 ...
 ("3D View Tool: Paint Grease Pencil, Cutter",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("grease_pencil.stroke_cutter", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ],
   },
  ),
 ...
 ("3D View Tool: Sculpt, Box Hide",
  ...
  {"items":
   [("paint.hide_show",
    ...
    ("paint.hide_show_all", {"type": 'LEFTMOUSE', "value": 'CLICK'}, None),
    ],
   },
  ),
 ...
 ("3D View Tool: Sculpt, Lasso Hide",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("paint.hide_show_lasso_gesture", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'}, None),
    ("paint.hide_show_lasso_gesture", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True}, None),
    ("paint.hide_show_all", {"type": 'LEFTMOUSE', "value": 'CLICK'}, None),
    ],
   },
  ),
 ...
 ("3D View Tool: Sculpt, Line Hide",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("paint.hide_show_line_gesture", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG'}, None),
    ("paint.hide_show_line_gesture", {"type": 'LEFTMOUSE', "value": 'CLICK_DRAG', "ctrl": True}, None),
    ("paint.hide_show_all", {"type": 'LEFTMOUSE', "value": 'CLICK'}, None),
    ],
   },
  ),
 ...
 ("3D View Tool: Sculpt, Polyline Hide",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("paint.hide_show_polyline_gesture", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("paint.hide_show_polyline_gesture", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ],
   },
  ),
 ("3D View Tool: Sculpt, Polyline Mask",
  {"space_type": 'VIEW_3D', "region_type": 'WINDOW'},
  {"items":
   [("paint.mask_polyline_gesture", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("paint.mask_polyline_gesture", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ],
   },
  ),
 ...
 ("Fill Tool Modal Map",
  {"space_type": 'EMPTY', "region_type": 'WINDOW', "modal": True},
  {"items":
   [("", {"type": 'ESC', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'RIGHTMOUSE', "value": 'PRESS'}, None),
    ("", {"type": 'LEFTMOUSE', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'S', "value": 'PRESS'}, None),
    ("", {"type": 'PAGE_UP', "value": 'PRESS', "repeat": True}, None),
    ("", {"type": 'WHEELUPMOUSE', "value": 'PRESS'}, None),
    ("", {"type": 'PAGE_DOWN', "value": 'PRESS', "repeat": True}, None),
    ("", {"type": 'WHEELDOWNMOUSE', "value": 'PRESS'}, None),
    ("", {"type": 'MIDDLEMOUSE', "value": 'PRESS'}, None),
    ("", {"type": 'D', "value": 'PRESS'}, None),
 ...
 ("Gesture Polyline",
  {"space_type": 'EMPTY', "region_type": 'WINDOW', "modal": True},
  {"items":
   [("", {"type": 'RET', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'ESC', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'RIGHTMOUSE', "value": 'ANY', "any": True}, None),
    ("", {"type": 'LEFTMOUSE', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'SPACE', "value": 'ANY', "any": True}, None),
    ],
   },
  ),
    ...
    ("wm.radial_control",
     ...
     {"properties":
      [("data_path_primary", 'tool_settings.gpencil_paint.brush.size'),
       ...
       ("rotation_path", 'tool_settings.gpencil_paint.brush.texture_slot.angle'),
       ("color_path", 'tool_settings.gpencil_paint.brush.cursor_color_add'),
       ("fill_color_path", ''),
 ...
 ("Grease Pencil Edit Mode",
  ...
  {"items":
   [("grease_pencil.select_all",
    ...
    ("grease_pencil.paste", {"type": 'V', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("wm.call_menu_pie",
     {"type": 'S', "value": 'PRESS', "shift": True},
     {"properties":
 ...
 ("Grease Pencil Fill Tool",
  ...
  {"items":
   [("grease_pencil.fill", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("grease_pencil.fill", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
 ...
 ("Grease Pencil Sculpt Mode",
  ...
  {"items":
   [("brush.scale_size",
    ...
    ("grease_pencil.sculpt_paint", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ("grease_pencil.sculpt_paint", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("wm.radial_control",
     {"type": 'F', "value": 'PRESS'},
     {"properties":
 ...
 ("Grease Pencil Weight Paint",
  ...
  {"items":
   [("grease_pencil.weight_brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("grease_pencil.weight_brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ("brush.scale_size",
     {"type": 'LEFT_BRACKET', "value": 'PRESS', "repeat": True},
     {"properties":
      [("scalar", 0.9),
 ...
 ("Image Editor Tool: Uv, Grab",
  ...
  {"items":
   [("sculpt.uv_sculpt_grab", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("sculpt.uv_sculpt_grab", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
 ...
 ("Image Editor Tool: Uv, Pinch",
  ...
  {"items":
   [("sculpt.uv_sculpt_pinch", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("sculpt.uv_sculpt_pinch", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ("sculpt.uv_sculpt_relax", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("wm.radial_control",
     {"type": 'F', "value": 'PRESS'},
     {"properties":
 ...
 ("Image Editor Tool: Uv, Relax",
  ...
  {"items":
   [("sculpt.uv_sculpt_relax", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("sculpt.uv_sculpt_relax", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ("sculpt.uv_sculpt_relax", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("wm.radial_control",
     {"type": 'F', "value": 'PRESS'},
     {"properties":
 ...
 ("Image Editor Tool: Uv, Sculpt Stroke",
  ...
  {"items":
   [("sculpt.uv_sculpt_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ("sculpt.uv_sculpt_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS', "ctrl": True}, None),
    ("sculpt.uv_sculpt_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True}, None),
    ("brush.scale_size",
     {"type": 'LEFT_BRACKET', "value": 'PRESS', "repeat": True},
     {"properties":
      [("scalar", 0.9),
 ...
 ("Mesh",
  ...
  {"items":
   [("transform.translate", {"type": 'G', "value": 'PRESS'}, None),
    ...
    ("uv.muv_texture_wrap_refer", {"type": 'C', "value": 'PRESS', "repeat": True}, None),
    ("uv.muv_texture_wrap_set", {"type": 'D', "value": 'PRESS', "repeat": True}, None),
    ("mesh.faces_select_linked_flat", {"type": 'GRLESS', "value": 'PRESS', "ctrl": True, "repeat": True}, None),
    ],
   },
  ),
 ...
 ("Node Editor",
  ...
  {"items":
   [("wm.call_menu",
    ...
    ("node.connect_to_output", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "alt": True}, None),
    ("node.connect_to_output", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "ctrl": True}, None),
    ("node.connect_to_output", {"type": 'LEFTMOUSE', "value": 'PRESS', "shift": True, "alt": True}, None),
 ...
 ("Primitive Tool Modal Map",
  ...
  {"items":
   [("", {"type": 'ESC', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'Q', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'MIDDLEMOUSE', "value": 'ANY', "any": True}, None),
    ("", {"type": 'RET', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'NUMPAD_ENTER', "value": 'PRESS', "any": True}, None),
    ("", {"type": 'E', "value": 'PRESS'}, None),
    ("", {"type": 'G', "value": 'PRESS'}, None),
    ("", {"type": 'R', "value": 'PRESS'}, None),
    ("", {"type": 'S', "value": 'PRESS'}, None),
    ("", {"type": 'UP_ARROW', "value": 'PRESS', "repeat": True}, None),
    ("", {"type": 'DOWN_ARROW', "value": 'PRESS', "repeat": True}, None),
    ],
   },
  ),
 ("Property Editor",
 ...
 ("Sculpt",
  ...
  {"items":
   [("sculpt.brush_stroke", {"type": 'LEFTMOUSE', "value": 'PRESS'}, None),
    ...
    ("paint.hide_show_all", {"type": 'H', "value": 'PRESS', "alt": True}, None),
    ("paint.visibility_filter", {"type": 'PAGE_UP', "value": 'PRESS', "repeat": True}, None),
    ("paint.visibility_filter", {"type": 'PAGE_DOWN', "value": 'PRESS', "repeat": True}, None),
 ...
 ("Sequencer Timeline Tool: Tweak (fallback)",
  {"space_type": 'SEQUENCE_EDITOR', "region_type": 'WINDOW'},
  {"items":
   [("sequencer.select",
     {"type": 'LEFTMOUSE', "value": 'PRESS'},
 ...
 ("View3D Walk Modal",
  ...
  {"items":
   [("CANCEL",
    ...
    ("CONFIRM", {"type": 'RIGHTMOUSE', "value": 'RELEASE', "shift": True}, None),
