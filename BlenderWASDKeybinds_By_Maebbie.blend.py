 ...
 ("Mesh",
  ...
  {"items":
   [("mesh.loopcut_slide",
    ...
    ("mesh.delete_loose", {"type": 'F10', "value": 'PRESS'}, None),
    ("mesh.faces_select_linked_flat", {"type": 'GRLESS', "value": 'PRESS', "ctrl": True}, None),
    ("uv.muv_texture_wrap_set", {"type": 'D', "value": 'PRESS'}, None),
    ("uv.muv_texture_wrap_refer", {"type": 'C', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("Armature",
 ...
 ("UV Editor",
  ...
  {"items":
   [("mesh.select_mode",
    ...
    ("uv.textools_uv_crop", {"type": 'F', "value": 'PRESS'}, None),
    ],
   },
  ),
 ("View3D Fly Modal",
